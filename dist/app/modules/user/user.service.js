...
const getAllUserService = (paginationOptions, filters) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateUserService = (email, body) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_model_1.default.findOneAndUpdate({ email: email }, body, {
        new: true,
    });
    return result;
});
